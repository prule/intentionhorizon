...
The in-app user guide overlay introduces Intention Horizon and gives first-time users enough guidance to get started, including concrete starter examples of categories and intentions, since fresh installs begin with no data.
