...
The application source is authored in TypeScript and type-checked as part of the build, giving compile-time safety over the React + Dexie codebase without changing runtime behavior.
