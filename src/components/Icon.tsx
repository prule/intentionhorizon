...
export const Icon: Record<string, IconFn> = {
  ...
  upload: (p) => (<svg width="19" height="19" viewBox="0 0 24 24" fill="none" {...p}><path d="M12 16V5m0 0l-4 4m4-4l4 4M5 19h14" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg>),
  ...
  calendar: (p) => (<svg width="19" height="19" viewBox="0 0 24 24" fill="none" {...p}><rect x="4" y="5.5" width="16" height="15" rx="2.2" stroke="currentColor" strokeWidth="1.7" /><path d="M4 9.5h16M8 3.5v3M16 3.5v3" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" /></svg>),
};
