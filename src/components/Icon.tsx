...
export const Icon: Record<string, IconFn> = {
  ...
  flame: (p) => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" {...p}>
      <path
        d="M12 3c.5 3-2 4.2-2 6.8 0 1 .6 1.8 1.4 1.8 1.2 0 1.6-1.2 1.3-2.6 1.7 1 2.8 2.9 2.8 5.1A5.5 5.5 0 016 14.4c0-2 1-3.4 2.2-4.7C10 7.8 11.8 6 12 3z"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinejoin="round"
      />
  ...
  help: (p) => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" {...p}>
      ...
      <path
        d="M9.4 9.4c0-1.5 1.2-2.4 2.6-2.4s2.5.9 2.5 2.3c0 1.9-2.4 2-2.4 3.6"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
      />
  ...
  calendar: (p) => (
    <svg width="19" height="19" viewBox="0 0 24 24" fill="none" {...p}>
      <rect x="4" y="5.5" width="16" height="15" rx="2.2" stroke="currentColor" strokeWidth="1.7" />
      <path
