/* ───────────────────────────────────────────────
   guide.jsx — full-screen user guide overlay
   ─────────────────────────────────────────────── */

function GBlock({ n, title, children }) {
  return (
...
function Guide({ onClose }) {
  ...
  const swatch = (r) => `color-mix(in oklab, ${heat} ${Math.round((0.22 + 0.78 * r) * 100)}%, var(--surface))`;
    ...
    <div className="guide-overlay">
      <div className="guide-col">
        ...
        <GBlock n="2" title="Totals & targets">
          Each intention shows a rolling <strong>7-day</strong> and <strong>30-day</strong> count. If you give an
          intention a target, the number tells you where you stand against it:
          <GExample>
